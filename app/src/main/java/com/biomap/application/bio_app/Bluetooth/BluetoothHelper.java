...
public class BluetoothHelper {
    ...
    private BluetoothHelper(Activity parent, BleWrapperUiCallbacks callback)
    {
        this.setDependencies(parent, callback);
    }

    public static BluetoothHelper getInstance(Activity parent, BleWrapperUiCallbacks callback)
    {
        if(mInstance == null)
        {
            mInstance = new BluetoothHelper(parent, callback);
        }
        else {
